<?php 
    ...
    echo '
        <form class="form" action="?process=new&forum='.$forum.'" method="post">
            ...
            <input class="user-input-field new-post-title" type="text" name="name" maxlength="50" placeholder="Title"><br>
            <textarea class="user-input-field new-post-content margin-bot-8" name="post-content" maxlength="10000" placeholder="Post text"></textarea><br>
            <center>
