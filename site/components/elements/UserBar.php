    ...
    <p>
        ...
        <span class="right">
            <?php 
                // check if user logged in
                if ($userController->isUserLogged()) {
                    echo '<a href="?process=logout" class="user-input-field width-limiter-100">Logout</a>';
                } else {
                    ...
                    if ($process != "login") {
                        ...
                        echo '<a href="?process=login" class="user-input-field width-limiter-100">Login</a>';
                    }
                    ...
                    if ($process != "register") {
                        ...
                        echo '<a href="?process=register" class="user-input-field width-limiter-100">Register</a>';
                    }
                }
            ?>
        </span>
