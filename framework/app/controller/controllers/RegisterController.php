<?php // user register controller
    ...
    class RegisterController {
        ...
        public function getUsers() {
            ...
            // get users
            $query = mysqli_query($mysqlUtils->mysqlConnect($pageConfig->getValueByName("basedb")), "SELECT * FROM users");
        ...
        public function registerUser($username, $email, $password) {
            ...
            if ($this->getUsers()->num_rows < 1) {

                // default user role (if users empty)
                $role = "owner";
            } else {
